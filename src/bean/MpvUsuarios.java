...
public class MpvUsuarios {
    ...
    private Date mpvDataNacimento;
    private int mpvNivel;
    private String mpvSenha;
    private String mpvArivo;
    ...
    /**
     * @return the mpvDataNacimento
     */
    public Date getMpvDataNacimento() {
        return mpvDataNacimento;
    }

    /**
     * @param mpvDataNacimento the mpvDataNacimento to set
     */
    public void setMpvDataNacimento(Date mpvDataNacimento) {
        this.mpvDataNacimento = mpvDataNacimento;
    }
     ...
     * @return the mpvArivo
     */
    public String getMpvArivo() {
        return mpvArivo;
    }

    /**
     * @param mpvArivo the mpvArivo to set
     */
    public void setMpvArivo(String mpvArivo) {
        this.mpvArivo = mpvArivo;
    }
